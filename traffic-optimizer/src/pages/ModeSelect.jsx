...
const MODES = [
  {
    ...
    tag: "Normal",
    title: "Shortest Path",
    desc: "Use A* pathfinding to find the most efficient route between any two points on the map.",
    features: [
      "A* pathfinding algorithm",
      "Distance or time weight",
      "Real-time road graph",
    ],
    color: "#10B981",
  ...
  },
  {
    ...
    desc: "Find the fastest route to the nearest hospital using A* pathfinding and priority-aware routing.",
    features: [
      "Hospital proximity search",
      "Priority lane routing",
      "Modified A* + POI layer",
    ],
    color: "#EF4444",
      ...
      <div className="mode-body">
        <div className="mode-heading">
          ...
          <p className="mode-sub">
            Select a mode below to begin optimizing your route
          </p>
        </div>
          ...
          {MODES.map((m) => (
            ...
            >
              ...
              <div className="mcard-icon-wrap">
                <span className="mcard-icon">
                  {m.icon}
                </span>
              </div>

              <p className="mcard-tag">
                {m.tag}
              </p>
